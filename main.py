...
def main():
    ...
    print('Investment Calculator v0.4.0 by Stas Vostrov\n')

    response = input('Выполнить полное обновление автоматически(y)\n'
                     'Выполнить действия по шагам самостоятельно(n): ').strip().lower()
    if response == 'y' or 'н':
        ...
        print('Неверный ответ. Обновление не выполнено')
